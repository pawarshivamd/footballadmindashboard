import { Box, Button, Card, Divider, FormControl, Grid, IconButton, Modal, Typography } from '@mui/material'
    ...
    />
              ...
              <Grid item lg={12} xs={12}>
                <FormControl fullWidth>
                  <Inputcustom InputLabelProps={{ shrink: true }} type="text" id="team-name" label='Team Name :' placeholder='Enter Team Name' variant="filled" />
                </FormControl>
              </Grid>
